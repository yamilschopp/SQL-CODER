...
#OBTENCION DE DESCRIPCIÓN DE PRODUCTO PASANDO ID DEL MISMO COMO PARÁMETRO
DELIMITER $$
...
#OBTENCION DE CANTIDAD DE UN TIPO DE PRODUCTO PASANDO ID DEL MISMO COMO PARÁMETRO
DELIMITER $$
